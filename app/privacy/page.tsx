      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16">
        ...
        <div className="space-y-8">
          {[
            ...
            {
              title: "Your Rights",
              content: "You have the right to access, correct, or delete your personal data. You can request a copy of your data or ask us to delete your account by contacting privacy@hoshmand.ai."
            },
            {
              title: "Cookies",
            ...
            {
              title: "Contact",
              content: "For privacy-related questions, contact us at privacy@hoshmand.ai or visit our Contact page."
            }
          ].map((section) => (
